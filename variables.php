...
<?php
	$language = "PHP";
	echo $greeting = "Welcome to $language.";
	echo "<hr style=\"margin 1rem 0\">";
	$firstName = "FirstName";
	$lastName = "LastName";
	$day = "14";
	$month = "February";
	$year = "1962";
	echo $assembled = "My name is $firstName $lastName. I was born on $day of $month in $year.";
	echo "<hr style=\"margin 1rem 0\">";
	$length = 6.5;
	$width = 3.5;
	echo "Area: ".$area = (2 * $length) + (2 * $width) ;
	echo "<hr style=\"margin 1rem 0\">";
	$product = "Armchair";
	$price = 249;
	$tax = 13;
	$delivery = 5;
	$total = '';
	echo "Price: $price Tax(13%):".($price*$tax/100)." Delivery(5%):".($price*$delivery/100)."<br />";
	$total = $price + ($price*$tax/100) + ($price*$delivery/100);
	echo $product.":$".$total; 
	echo "<hr style=\"margin 1rem 0\">";
?>
<figure>
	<img src="http://placehold.jp/300x300.png" title="<?php echo $product; ?>" width="300" height="300" />
	<figcaption><?php echo $product.":$".$total; ?></figcaption>
</figure>
<?php echo "<hr style=\"margin 1rem 0\">"; ?>